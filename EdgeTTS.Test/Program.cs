    ...
    class Program
    {
        static void Main(string[] args)
        {
            Log.Logger = new LoggerConfiguration()
                ...
                .CreateLogger();
            var t = new EdgeTTSClient(true, true);
            //t.Sec_MS_GEC_UpDate_Url = "http://123.207.46.66:8086/api/getGec";
            ...
            var str = "今天天气真的热";
            Say(t, str, "zh-CN-XiaoyiNeural");
            Console.ReadKey();

        }

        public static void Say(EdgeTTSClient t, string str, string voice)
        {
